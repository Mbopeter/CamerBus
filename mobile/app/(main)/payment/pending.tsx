...
import { Hourglass, Camera, Eye, Check, Lightbulb, ArrowLeft, Ticket as TicketIcon } from 'lucide-react-native';
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.stepsWrap}>
          {[
            { icon: <Camera size={18} color="rgba(255,255,255,0.6)" />, doneIcon: <Camera size={18} color="#fff" />, text: 'Proof submitted', done: true },
            { icon: <Eye size={18} color="rgba(255,255,255,0.6)" />, doneIcon: <Eye size={18} color="#fff" />, text: 'Admin reviewing', done: false },
            { icon: <Check size={18} color="rgba(255,255,255,0.6)" />, doneIcon: <Check size={18} color="#fff" />, text: 'Ticket issued',   done: false },
          ].map((s, i) => (
            <View key={i} style={styles.stepRow}>
              <View style={[styles.stepCircle, s.done && styles.stepCircleDone]}>
                {s.done ? s.doneIcon : s.icon}
              </View>
        ...
        <View style={styles.tipBox}>
          <View style={{ flexDirection: 'row', alignItems: 'flex-start', gap: 10 }}>
            <Lightbulb size={18} color="rgba(255,255,255,0.85)" style={{ marginTop: 2 }} />
        ...
        <TouchableOpacity onPress={() => router.push('/(main)/tickets')} style={{ marginTop: 8 }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
            <TicketIcon size={16} color="#FCD116" />
...
const styles = StyleSheet.create({
  ...
  tipText:         { flex: 1, fontSize:13, color:'rgba(255,255,255,0.85)', lineHeight:22 },
