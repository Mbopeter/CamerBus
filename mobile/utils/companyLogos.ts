export const COMPANY_LOGOS: Record<string, any> = {
  general: require('../assets/Generalexpress.jpg'),
  buca: require('../assets/Bucaexpress.jpg'),
  nso: require('../assets/Nsoboys.jpg'),
  afrique: require('../assets/afriquelanexpress.png'),
  confort: require('../assets/confort voyage.jpg'),
  finexs: require('../assets/finexsvoyage.png'),
  garanti: require('../assets/garantiexpress.jpg'),
  moghamo: require('../assets/moghamoexpress.jpg'),
  musango: require('../assets/musangobusservice.jpg'),
  oasis: require('../assets/oasistarvels.jpg'),
  starline: require('../assets/starlinestravels.png'),
  touristique: require('../assets/touristiqueexpress.jpg'),
  united: require('../assets/unitedexpress.jpg'),
  vatican: require('../assets/vaticanexpress.jpg'),
  amour: require('../assets/Amourmezamexpress.jpg'),
  default: require('../assets/Bus.jpg'),
};
